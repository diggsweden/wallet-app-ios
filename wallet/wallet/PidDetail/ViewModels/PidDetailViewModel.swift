...
class PidDetailViewModel: ObservableObject {
    ...
    let configOpenId4: OpenId4VCIConfig = OpenId4VCIConfig(
        clientId: "wallet-dev",
        authFlowRedirectionURI: URL(string: String("eudi-wallet//auth"))!
    )
    ...
    func issuer() async {
        do {
            ...
            if case let .preAuthorizedCode(preAuthCode) = credentialOffer!
                .grants!
            {
    ...
    func fetchCredential() async {
            ...
            let requestModel = CredentialRequestModel(
                ...
                proof: Proof(proof_type: "jwt", jwt: "eyJ0eXAiOiJvcGVuaWQ0dmNpLXByb29mK2p3dCIsImFsZyI6IkVTMjU2IiwiandrIjp7Imt0eSI6IkVDIiwiY3J2IjoiUC0yNTYiLCJ4IjoiRHN4S1BwaUVseG9UYUJZcFN5QVdrdWFxUmxfbnpGNUFkZTBwM0FlOHg3VSIsInkiOiIxMUdtQVpOY0dtUGlXQWg5M20zNUkweUptX2V1VE5mcFVUbGxHN2F5SHlvIn19.eyJhdWQiOiJodHRwczovL3dhbGxldC5zYW5kYm94LmRpZ2cuc2UiLCJub25jZSI6IjZRX0x1bnRXZkdkZ1BoNjBMWkY2S2kxWHhXUkhMSTdJOXdpeXBVNkpRcGciLCJpYXQiOjE3NDY1MTQ0NzV9.TAwlcDkYFJgkCiP8_mbJ6yBrwdgXEiYe23RBdM5TSQUTa04eqY4nMQ5Igd9wLchToovLgZGpYO62d2y7wlcf4g")
            )
            ...
            do {
                ...
                credential = try JSONDecoder().decode(CredentialResponseModel.self, from: data)
